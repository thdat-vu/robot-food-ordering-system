...
export const ProductionDetailDialog: React.FC<Props> = ({
  isOpen,
  isClosed,
  id,
}) => {
  ...
  const handleLoadingTopping = async () => {
    ...
    try {
      ...
      const res: BaseEntityDataError<ProductToppingList> =
        await runGetAllProductTopping(id);
  ...
  const handleLoadingProductDetail = async () => {
    try {
      ...
      const res: BaseEntityDataError<ProductionDetail> =
        await runGetProductionDetail(id);
  ...
  return (
    <>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                  ...
                  <Button size="sm" onClick={() => setImportToppingModal(true)}>
      ...
      <AlertDialog
        ...
        onOpenChange={setDeleteProductAlert}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Xác nhận xóa món ăn</AlertDialogTitle>
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xóa món ăn "{product?.name}"? Hành động này
              không thể hoàn tác.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog
        open={deleteToppingAlert}
        onOpenChange={setDeleteToppingAlert}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Xác nhận xóa topping</AlertDialogTitle>
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xóa topping này? Hành động này không thể
              hoàn tác.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
