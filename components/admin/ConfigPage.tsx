...
export const ConfigPage: React.FC = () => {
    ...
    return (
        <>
                                        ...
                                        <CardContent className="p-4">
                                            <div
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div
                                                        className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-muted text-sm font-mono">
                                                        {config.value}
                                                    </div>
                                                </div>
                                                <Button
            ...
            <Dialog open={restrictionDialog.open}
                    onOpenChange={(v) => setRestrictionDialog(prev => ({...prev, open: v}))}>
                <DialogContent className="sm:max-w-[460px]">
                    <DialogHeader>
                        <DialogTitle>Không thể đổi ngay</DialogTitle>
                        <DialogDescription>
                            Hệ thống đang ở chế độ "Thanh toán trước". Bạn chỉ có thể đổi sang "Thanh toán sau"
                            từ {formatVnDate(restrictionDialog.availableAt)}.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button onClick={() => setRestrictionDialog({open: false, availableAt: null})}>Đã
                            hiểu</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
                ...
                <DialogContent className="sm:max-w-[420px]">
                    ...
                    <DialogFooter>
                        <Button variant="outline"
                                onClick={() => setConfirmDialog({open: false, target: null})}>Hủy</Button>
