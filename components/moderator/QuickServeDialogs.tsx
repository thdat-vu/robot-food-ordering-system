      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-base text-gray-600">
             Hệ thống phát hiện còn <strong>{otherCount}</strong> yêu cầu phục vụ nhanh từ các bàn: <strong>{otherTableNames.join(", ")}</strong>. <br/>
    ...
    return (
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-base text-gray-600">
              Bạn đang thực hiện xử lý <strong>{count}</strong> yêu cầu phục vụ nhanh đang chờ từ các bàn: <strong>{tableNames.join(", ")}</strong>.<br/>
