...
export const Frame2: React.FC<FrameProps> = ({onNext, onSkip,isLoading = false}) => {
    return (
        <div
            ...
            <div className="flex flex-col items-center mt-10">
                ...
                <h2 className="text-2xl font-bold text-gray-900 text-center font-['Poppins']">
                    Chọn món từ đầu bếp yêu thích
                </h2>

                <p className="text-center text-gray-500 text-base font-medium font-['Poppins'] leading-relaxed mt-3 px-4">
                    Tất cả món ăn được chế biến tươi ngon bởi các đầu bếp của nhà hàng.
                    <br/>
                    Bạn chỉ cần chọn món, đầu bếp sẽ chuẩn bị ngay cho bạn tại bếp mở.
                </p>
            </div>
