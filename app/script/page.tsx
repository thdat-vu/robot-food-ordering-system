...
export default function ScriptPage() {
  ...
  const handleRunScript = async () => {
    ...
    try {
      ...
      const response = await apiClient.get("/Table/random-scan-and-order", {
        params,
      });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <span
                          className={`text-sm font-semibold ${
                            result.orderResult.statusCode === 200 ||
                            result.orderResult.statusCode === 201
                              ? "text-green-600 dark:text-green-400"
                              : "text-red-600 dark:text-red-400"
                          }`}
                        >
              ...
              {!result && !error && !loading && (
                <div
                  className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-12 border border-gray-200 dark:border-gray-700 
                            text-center"
                >
