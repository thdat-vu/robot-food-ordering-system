                ...
                <div className="text-center mb-8">
                    <div className="relative flex justify-center items-center mb-6">
                        ...
                        <div
                            ...
                            <div className="flex items-center gap-3">
                                <span
                                    className="w-4 h-4 rounded-full bg-gradient-to-br from-gray-100 to-gray-700 animate-pulse"></span>
                    ...
                    <div className="flex justify-center mb-8 px-4">
                        <div className="relative w-full max-w-lg group">
                            ...
                            <div
                                className="relative flex items-center bg-gradient-to-r from-purple-600/30 via-pink-500/30 to-purple-600/30 backdrop-blur-2xl rounded-3xl px-5 sm:px-7 py-3 sm:py-4 transition-all duration-500 group-hover:scale-[1.02]">
                                {/* Search icon with animation */}
                                <div className="relative">
                                    <Search
                                        className="w-5 h-5 sm:w-6 sm:h-6 text-purple-100 mr-3 sm:mr-4 flex-shrink-0 transition-transform duration-300 group-hover:scale-110"/>
                                    <div
                                        className="absolute inset-0 bg-purple-400 rounded-full blur-md opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>
                                </div>
                            ...
                            <div
                                className="absolute inset-0 bg-gradient-to-r from-purple-600/20 via-pink-500/20 to-purple-600/20 rounded-3xl blur-2xl -z-10 opacity-60 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>

                            {/* Bottom shine effect */}
                            <div
                                className="absolute bottom-0 left-1/4 right-1/4 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent"></div>
                        </div>
                    </div>
