...
export const FeedbackPage: React.FC<FeedbackPageProps> = ({idTable}) => {
    ...
    const getStatusInfo = (status: number) => {
        switch (status) {
            case 0:
                return {label: 'Chờ xử lý', color: 'text-yellow-600 bg-yellow-50 border-yellow-200'};
            case 1:
                return {label: 'Đang chuẩn bị', color: 'text-orange-600 bg-orange-50 border-orange-200'};
            case 2:
                return {label: 'Hoàn thành', color: 'text-green-600 bg-green-50 border-green-200'};
            case 3:
                return {label: 'Đã hủy', color: 'text-red-600 bg-red-50 border-red-200'};
            default:
                return {label: 'Không xác định', color: 'text-gray-600 bg-gray-50 border-gray-200'};
        }
    };
        ...
        <>
            ...
            <div className="h-full flex flex-col">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                    <div
                        className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl px-4 py-3 text-center border-2 border-yellow-200">
                        <div className="flex items-center justify-center space-x-2 mb-1">
                            <AlertCircle className="w-5 h-5 text-yellow-600"/>
                            <span className="text-2xl font-bold text-yellow-700">{pendingCount}</span>
                        </div>
                        <span className="text-sm text-yellow-700 font-medium">Chưa xử lý</span>
                    </div>
                    <div
                        className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl px-4 py-3 text-center border-2 border-green-200">
                        <div className="flex items-center justify-center space-x-2 mb-1">
                            <CheckCircle className="w-5 h-5 text-green-600"/>
                            <span className="text-2xl font-bold text-green-700">{processedCount}</span>
                        </div>
                        <span className="text-sm text-green-700 font-medium">Đã xử lý</span>
                    </div>
                    <div
                        className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl px-4 py-3 text-center border-2 border-blue-200">
                        <div className="flex items-center justify-center space-x-2 mb-1">
                                    ...
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center space-x-3">
                                                    <span
                                                        className="bg-white px-3 py-1 rounded-full text-sm font-bold text-gray-600 shadow-sm">
                                                        #{index + 1}
                                                    </span>
                                                    <div
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                                        {(() => {
                                                            ...
                                                            return Object.values(groupedItems).map(({item, count}) => {
                                                                        ...
                                                                        <div className="flex items-center space-x-3">
                                                                            ...
                                                                            <div className="flex-1 min-w-0">
                                                                                <h5 className="font-semibold text-gray-800 text-sm mb-1">
                                                                                    ...
                                                                                    {count > 1 && (
                                                                                        <span
                                                                                            className="ml-2 bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs font-bold">
                                                                                            x{count}
                                                                                        </span>
                                                                                    )}
                                                                                </h5>
                                            ...
                                            <div
                                                ...
                                                <div className="flex items-center space-x-2 mb-2">
                                                    ...
                                                    <h4 className="font-semibold text-gray-700 text-sm">Nội dung phản
                                                        hồi:</h4>
                                                </div>
                                                <p
                                            ...
                                            <div
                                                ...
                                                <div className="flex items-center justify-between mb-3">
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <h4 className="font-semibold text-gray-700 text-sm">Phản hồi cho
                                                            khách hàng:</h4>
                                                    </div>
                                                    <button
                                                    ...
                                                    >
                                                        {isChecking ? (
                                                            <>
                                                                <RefreshCw className="w-4 h-4 animate-spin"/>
                                                                <span
                                                                    className="font-semibold text-sm">Đang xử lý...</span>
                                                            </>
                                                        ) : (
                                                            <>
                                                                <CheckCircle className="w-4 h-4"/>
                                                                <span className="font-semibold text-sm">Đánh dấu đã xử lý</span>
                                                            </>
                                                        )}
                                                    </button>
                                                </div>
