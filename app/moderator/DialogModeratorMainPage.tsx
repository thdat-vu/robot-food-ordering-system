...
> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div
                className="bg-white rounded-3xl shadow-2xl w-full max-w-7xl h-[90vh] flex overflow-hidden border border-gray-200">
                {/* Sidebar */}
                ...
                <main className="flex-1 bg-gray-50 p-8 overflow-auto">
                    ...
                    {tab === "activityTracking" && (
                        <TableActivityTracker propSessionId={tableSessionId}/>
                    )}
                </main>
            </div>
        </div>
