...
import {useChangeTableApi, useGetALlTable} from "@/hooks/moderator/useTableHooks";
...
export const ChangeTable: React.FC<Props> = ({id, onClose}) => {
    ...
    const handleChangeTable = async () => {
        ...
        try {
            const res: messss = await runChangeTable(id, newTable, reason);
    ...
    return (
        <div className="w-full h-full bg-gray-50 py-8 px-5 relative">
            ...
            {isLoading && (
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
                    <div className="bg-white rounded-2xl p-8 shadow-2xl flex flex-col items-center">
                        ...
                        <p className="text-lg font-semibold text-gray-700">Đang xử lý đổi bàn...</p>
            ...
            <div className="flex items-center justify-center gap-14">
                {/* Bàn hiện tại */}
                <div
                    className="w-64 h-64 bg-white border-2 border-gray-300 rounded-2xl shadow flex items-center justify-center text-xl font-semibold">
            ...
            <div className="mt-12 flex justify-center">
                <input
                    ...
                    disabled={isLoading}
                    className="w-3/4 p-4 text-lg border-2 border-gray-300 rounded-xl shadow focus:outline-none focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                />
            </div>
            ...
            {showConfirmDialog && (
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                    <div className="bg-white w-96 p-6 rounded-2xl shadow-lg">
                        <h2 className="text-xl font-semibold mb-4 text-center">Xác nhận đổi bàn?</h2>
            ...
            {showResultDialog && (
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                    <div className="bg-white w-96 p-6 rounded-2xl shadow-lg text-center">
                        ...
                        <h2
                            className={`text-xl font-bold mb-4 ${resultSuccess ? "text-green-600" : "text-red-600"}`}>
